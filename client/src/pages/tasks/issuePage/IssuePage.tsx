...
interface issueSecondaryContent {
  status: String,
  priority: String,
  labels: String[]
}
...
interface issueData {
  uuid: String,
  mainContent: issueMainContent,
  secondaryContent: issueSecondaryContent
}
